...
public class ImportTaskRepository {
    ...
    private static final RowMapper<ImportTaskRecord> IMPORT_TASK_ROW_MAPPER = (rs, rowNum) -> new ImportTaskRecord(
            rs.getLong("id"),
    ...
    public ImportTaskRepository(JdbcTemplate jdbcTemplate) {
    ...
    public long insert(String taskName,
        ...
        jdbcTemplate.update(connection -> {
            PreparedStatement statement = connection.prepareStatement("""
                    INSERT INTO import_tasks (task_name, file_path, file_name, status, requester_id, success_count, failure_count, error_report_path, detail, created_by, updated_by)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                    """, new String[]{"id"});
    ...
    public List<ImportTaskRecord> findAll() {
